...
int olsrd_plugin_interface_version(void) {
  return GPSREC_INTERFACE_VERSION;
}
 ...
 */
static void __attribute__ ((constructor)) gpsrec_init(void);

/**
 Shared library entrypoint declaration for destruction
 */
static void __attribute__ ((destructor)) gpsrec_fini(void);


/**
 Shared library entrypoint for initialisation
 */
static void gpsrec_init(void) {
}

/**
 Shared library entrypoint for destruction
 */
static void gpsrec_fini(void) {
  close_gpsrec();
}
